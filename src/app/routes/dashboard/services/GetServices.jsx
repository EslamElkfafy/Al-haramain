...
export const GetDashboardServicesRoute = () => {
  ...
  const ComponentOfServiceDisplay = ({
    ...
    return (
      <div
        ...
        onClick={() => router(`/dashboard/service/${_id}`)}
      >
        <img
          src={images[0]?.url}
    ...
    <div className="py-8 px-4">
      <div className="flex justify-between mb-3">
        <div className="flex flex-col">
          <h1 className="text-3xl font-medium ">الجميع الخدمات</h1>
          <p className="text-base font-normal">
          الصفحة الرئيسية / جميع الخدمات
          </p>
        </div>
        <Button intent={"red"} classsName={"!rounded-lg"} onClick={() => router("/dashboard/service/add")}>
        إضافة خدمه جديد
        </Button>
      </div>
